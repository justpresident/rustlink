...
use crate::app::App;
use crate::commands::{CommandRegistry, CommandResult, execute_input, get_completions};
...
// ============================================================================
// Main render function for Normal mode
// ============================================================================
...
pub fn handle_key(key: KeyEvent, app: &mut App, registry: &mut CommandRegistry) -> KeyResult {
    match key.code {
        ...
        KeyCode::Enter => {
            ...
            let command_result = execute_input(registry, app);
            ...
            match command_result {
                ...
                CommandResult::ConnectionChanged {
                    ...
                    return KeyResult::ConnectionChanged {
                        old_server_type,
                        new_server_type,
                    };
                }
